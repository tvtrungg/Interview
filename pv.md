...
---
interface, type, asyn, await, ES5, ES6,...
implement APi 
...
- PATCH (tương tự PUT):  Được dùng để thay đổi data, thế nhưng nó chỉ thay đổi những field được yêu cầu thay đổi thay vì toàn bộ resource.
...
- Có thể hiểu đơn giản là "cấp quyền truy cấp cho người mang (bearer) token này". 
